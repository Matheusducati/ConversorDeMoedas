...
function ConversorDeMoedas() {
  ...
  useEffect(() => {
    fetch('http://api.exchangeratesapi.io/v1/latest?access_key=98c0409403e82402bf508575527e00c0&format=1')
  ...
  const converterMoeda = () => {
    fetch(`http://api.exchangeratesapi.io/v1/latest?access_key=98c0409403e82402bf508575527e00c0&format=1base=${deMoeda}&symbols=${paraMoeda}`)
      .then(response => response.json())
      .then(data => {
